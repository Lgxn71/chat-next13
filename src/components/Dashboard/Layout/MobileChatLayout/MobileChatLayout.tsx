...
import FriendRequestSidebarOptions from "../FriendRequestSideBarOption/FriendRequestSideBarOption";

import Button, { buttonVariants } from "../../../UI/Buttons/Buttons";
import { Icons } from "../../../UI/Icons/Icons";

import { SidebarOptions } from "@/app/dashboard/layout";
    ...
    <div className="fixed bg-zinc-50 border-b border-zinc-200 top-0 inset-x-0 py-2 px-4">
      <div className="w-full flex justify-between items-center">
        ...
        <Button onClick={() => setOpen(true)} className="gap-4">
          <Icons.Menu className="h-6 w-6 text-indigo-600" />
        </Button>
      </div>
